# Bybit Pump Detector (Linear Futures)
...
Практика показала, что для малоликвидной линейной секции Bybit:
- k ≈ 8–12 хорошо отделяет фоновые колебания от реальных всплесков.
- Выбор точного числа зависит от:
- средней ликвидности инструмента
- частоты сделок
- времени окна (1s, 3s, 5s)

k — регулятор чувствительности детектора, подбираемый экспериментально на исторических потоках.
